...
@section('content')
    <div class="row">
    <div class="col-lg-12"><h3 style="font-weight:normal" class="pull-left"> <i class="fa fa-user"></i> {{ str_contains(URL::full(), 'edit') ? 'Edit' : 'Tambah' }} User </h3>
    ...
    <form action="{{ isset($data) ? earsip_route('pejabat.update', $data->id) : earsip_route('pejabat.store')}}" method="post" class="form" enctype="multipart/form-data">
        ...
        @csrf
            ...
            <small for="">Pangkat Golongan</small>
            <input type="text" class="form-control form-control-sm " value="{{ $data->pangkat_golongan ?? null }}" name="pangkat_golongan">
