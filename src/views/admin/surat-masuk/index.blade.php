...
@section('content')
<div class="row">
<div class="col-lg-12"><h3 style="font-weight:normal" class="pull-left"> <i class="fa fa-envelope"></i> Surat Masuk </h3>
    @if(earsip_user()?->pejabat?->alias_jabatan=='OPERATOR')
    <a href="{{ earsip_route('surat-masuk.create') }}" class=" btn btn-primary btn-sm pull-right"> <i class="fa fa-plus"></i> Tambah</a>
    @endif
</div>
